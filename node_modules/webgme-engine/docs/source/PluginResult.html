...
<head>
	...
	<title>WebGME Class: PluginResult</title>
...
<hr>
<dt>
    <h4 class="name" id="PluginResult"><span class="type-signature"></span>new PluginResult(config)</h4>
...
<hr>
<dt>
    <h4 class="name" id="addCommit"><span class="type-signature"></span>addCommit(commitData)</h4>
...
<hr>
<dt>
    <h4 class="name" id="getError"><span class="type-signature"></span>getError()</h4>
...
<hr>
<dt>
    <h4 class="name" id="getFinishTime"><span class="type-signature"></span>getFinishTime()</h4>
...
<hr>
<dt>
    <h4 class="name" id="getStartTime"><span class="type-signature"></span>getStartTime()</h4>
...
<hr>
<dt>
    <h4 class="name" id="setError"><span class="type-signature"></span>setError(time)</h4>
...
<hr>
<dt>
    <h4 class="name" id="setFinishTime"><span class="type-signature"></span>setFinishTime(time)</h4>
...
<hr>
<dt>
    <h4 class="name" id="setPluginId"><span class="type-signature"></span>setPluginId(pluginName)</h4>
...
<hr>
<dt>
    <h4 class="name" id="setPluginName"><span class="type-signature"></span>setPluginName(pluginName)</h4>
...
<hr>
<dt>
    <h4 class="name" id="setProjectId"><span class="type-signature"></span>setProjectId(projectId)</h4>
...
<hr>
<dt>
    <h4 class="name" id="setStartTime"><span class="type-signature"></span>setStartTime(time)</h4>
