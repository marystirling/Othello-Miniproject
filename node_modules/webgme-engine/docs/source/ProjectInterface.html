...
<head>
	...
	<title>WebGME Class: ProjectInterface</title>
...
<hr>
<dt>
    <h4 class="name" id="ProjectInterface"><span class="type-signature"></span>new ProjectInterface(projectId, storageObjectsAccessor, mainLogger, gmeConfig)</h4>
...
<hr>
<dt>
    <h4 class="name" id="~loadObjectCallback"><span class="type-signature"></span>loadObjectCallback(err, object)</h4>
