"""
This script is called by the plugin-wrapper, PlayerMoves.js, which passes down the
...
plugin = PlayerMoves(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
